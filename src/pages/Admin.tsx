          ...
          <div className="mb-6">
            <div className="flex gap-4 text-sm">
              ...
              <span className="text-green-500">
                Approved: <strong>{reviews.filter(r => r.approved).length}</strong>
              </span>
              <span className="text-yellow-500">
                Pending: <strong>{reviews.filter(r => !r.approved).length}</strong>
              </span>
            </div>
          </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <Badge 
                          ...
                          className={review.approved ? "bg-green-500 text-white" : "bg-yellow-500 text-black"}
                        >
