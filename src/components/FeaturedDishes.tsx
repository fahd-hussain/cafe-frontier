...
const FeaturedDishes = () => {
  ...
  const dishes = [
    ...
    },
    {
      ...
      price: "3200",
      image: bbqPlatter,
      description: "Assorted barbecue platter with seekh kababs, chicken boti, malai boti, lamb chops, naan and chutney",
    ...
    },
    {
      ...
      price: "850",
      image: chickenChilli,
      description: "Spicy chicken chilli with bell peppers served with rice",
    ...
    },
    {
      ...
      description: "Fragrant mutton biryani served hot in a traditional handi",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-4 animate-float">
            Featured <span className="text-accent animate-spice-dance inline-block">Dishes</span>
          </h2>
                ...
                <div className="aspect-square overflow-hidden rounded-t-lg relative">
                  <FavoriteButton 
                    dish={{
                      id: dish.id,
                      name: dish.name,
                      price: parseFloat(dish.price.split(' / ')[1] || dish.price.split(' / ')[0]),
                      image: dish.image,
