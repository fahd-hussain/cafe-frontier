            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-white leading-relaxed mb-8 animate-fade-in">
                        Frontier Restaurant in Karachi has been serving
                        authentic Desi cuisine since{' '}
                        <span className="text-accent font-semibold animate-appetite-pulse inline-block">
                            1972
                        </span>
                        . Located in the Sea Breeze Centre at Boat Basin, we
                    ...
                    <p className="text-lg text-muted-foreground animate-bounce-slow">
                        ...
                        doorstep, experience the legacy of Desi taste at
                        Frontier.
                    </p>
                </div>
            </div>
