        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              We value your opinion! Let us know how your experience was.
            </p>
          </div>
          ...
          <Card className="mb-12 bg-card border-border shadow-card">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Label className="text-foreground">Star Rating</Label>
                  <div className="mt-2">
                ...
                <div>
                  <Label htmlFor="comment" className="text-foreground">Comments</Label>
                  <Textarea
                    id="comment"
                    value={comment}
          ...
          <div>
            ...
            {reviews.length === 0 ? (
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {reviews.map((review) => (
                  <Card key={review.id} className="bg-card border-border shadow-card hover:shadow-glow transition-all duration-300">
