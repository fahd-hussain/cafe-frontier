...
const heroBackground = "/lovable-uploads/03cef6a7-948f-43e5-9211-c951b8a0e463.png";
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-4">
        <div className="text-center max-w-4xl">
          <h1 className="font-display text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in">
            ...
            <span className="text-accent animate-spice-dance inline-block">Frontier</span>
          </h1>
