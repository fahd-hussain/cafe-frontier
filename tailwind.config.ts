            ...
            keyframes: {
                ...
                smoke: {
                    ...
                    '50%': {
                        opacity: '0.4',
                        transform:
                            'translateY(-30px) scale(1.2) rotate(180deg)',
                    },
                    '100%': {
                        opacity: '0',
                        transform:
                            'translateY(-60px) scale(1.5) rotate(360deg)',
                    },
                },
            },
            animation: {
                ...
                sizzle: 'sizzle 0.5s ease-in-out infinite',
                'bounce-slow': 'bounce-slow 2s infinite',
                'dish-rotate': 'dish-rotate 20s linear infinite',
